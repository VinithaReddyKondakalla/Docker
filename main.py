...
output += " The Files and directories in " + str(path) +" : " + str(dir_list)
...
output += "\n\n The number of words in Limerick.txt: " + str(number_of_words1)
...
output += "\n\nThe total number words in both files: " + str(number_of_words2)+str(number_of_words1)
...
output += "\n\nThe top 3 max frequent words in IF.txt: " + str(top_3_words)
